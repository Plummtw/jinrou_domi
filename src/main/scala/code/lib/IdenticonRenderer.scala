package org.plummtw.jinrou_domi.lib
...
object IdenticonRenderer {
  private val DEFAULT_PATCH_SIZE = 20
	...
	private val patch0 = Array[Byte]( 0, 4, 24, 20, 0)
	private val patch1 = Array[Byte]( 0, 4, 20, 0 )
	private val patch2 = Array[Byte]( 2, 24, 20, 2 )
	private val patch3 = Array[Byte]( 0, 2, 22, 20, 0 )
	private val patch4 = Array[Byte]( 2, 14, 22, 10, 2 )
	private val patch5 = Array[Byte]( 0, 14, 24, 22, 0 )
	private val patch6 = Array[Byte]( 2, 24, 22, 13, 11, 22, 20, 2 )
	private val patch7 = Array[Byte]( 0, 14, 22, 0 )
	private val patch8 = Array[Byte]( 6, 8, 18, 16, 6 )
	private val patch9 = Array[Byte]( 4, 20, 10, 12, 2, 4 )
	private val patch10 = Array[Byte]( 0, 2, 12, 10, 0 )
	private val patch11 = Array[Byte]( 10, 14, 22, 10 )
	private val patch12 = Array[Byte]( 20, 12, 24, 20 )
	private val patch13 = Array[Byte]( 10, 2, 12, 10 )
	private val patch14 = Array[Byte]( 0, 2, 10, 0 )
  ...
  class IdenticonShape (val patchSize : Int, val fore : Color, val back : Color,
    ...
    for (i <- 0 until patchTypes.length) {
      ...
      for (j <- 0 until patchTypes.length) {
