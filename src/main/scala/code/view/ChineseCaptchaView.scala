package org.plummtw.jinrou_domi.view

import net.liftweb.common.{Box, Full}
import org.plummtw.jinrou_domi.lib.ChineseTextProducer
...
object ChineseCaptchaView {
  ...
  val DEFAULT_FONTS = List(//"新細明體", "細明體", "標楷體",
                              //"微軟正黑體", 
                              "王漢宗中明體注音",
                              "王漢宗中楷體注音").map(new Font(_, Font.BOLD, 40))
